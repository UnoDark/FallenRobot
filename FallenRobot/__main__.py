...
buttons = [
    ...
    [
        InlineKeyboardButton(text="💔 sᴜᴘᴘᴏʀᴛ 💔", url=f"https://t.me/{Hangawtss}"),
        InlineKeyboardButton(
            text="🍑 ᴅᴇᴠᴇʟᴏᴘᴇʀ 🍑", url=f"https://t.me/{OneUnoOnly}"
        ),
    ],
]

FallenRobot_IMG = "https://te.legra.ph/file/d1ccc90659b4d323ddf32.jpg"
